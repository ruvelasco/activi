import 'package:arasaac_activities/models/canvas_image.dart';
import 'package:flutter/material.dart';

class TemplatePainter extends CustomPainter {
  final TemplateType templateType;

  TemplatePainter(this.templateType);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    switch (templateType) {
      ...
      case TemplateType.comic6:
        ...
        // Líneas horizontales
        canvas.drawLine(
          Offset(margin, thirdY),
          Offset(size.width - margin, thirdY),
          thickPaint,
        );
        canvas.drawLine(
          Offset(margin, thirdY * 2),
          Offset(size.width - margin, thirdY * 2),
          thickPaint,
        );
        // Línea vertical
        canvas.drawLine(
          Offset(halfX, margin),
          Offset(halfX, size.height - margin),
          thickPaint,
        );
      ...
      case TemplateType.twoColumns:
        ...
        final midX = size.width / 2;
        canvas.drawLine(Offset(midX, 0), Offset(midX, size.height), thickPaint);
        break;
      ...
      case TemplateType.shadowMatching:
        ...
        // Líneas horizontales para separar las 5 filas
        for (int i = 1; i < 5; i++) {
        ...
        textPainter.paint(
          canvas,
          Offset(
            size.width / 2 + margin + columnWidth / 2 - textPainter.width / 2,
            10,
          ),
        );
