                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isTextSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isTextSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isShapesSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isShapesSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isArasaacSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isArasaacSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                        ],
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label: const Text('SoyVisual',
                                  style: TextStyle(fontSize: 13)),
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isSoyVisualSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isSoyVisualSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isTemplatesSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isTemplatesSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                        ],
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label: const Text('Creador',
                                  style: TextStyle(fontSize: 13)),
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isCreatorSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isCreatorSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    isConfigSelected ? Colors.blue[700] : null,
                                foregroundColor:
                                    isConfigSelected ? Colors.white : null,
                              ),
                            ),
                          ),
                          const SizedBox(width: 8),
